...
#			from kivy.uix.slider import Slider
	...
	# Create the rest of the UI objects (and bind them to callbacks, if necessary):
                ...
                leftsig_button = ToggleButton(text="Left\nSignal", group='signals', halign='center' , size_hint=(.14,.14*2),pos = (228,20))
                leftsig_button.bind(on_press=press_callback)
                hazard_button = ToggleButton(text="Hazard", group='signals',size_hint=(.14,.14*2),pos = (342,20))
                hazard_button.bind(on_press=press_callback)
                rightsig_button = ToggleButton(text="Right\nSignal", group='signals',halign='center',size_hint=(.14,.14*2),pos = (456,20))
